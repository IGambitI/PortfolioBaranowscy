...
const Header = () => {
  ...
  return (
    <nav className={`${style.paddingX} w-full flex items-center py5 fixed top-0 z-20 bg-primary`}>
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>

        {/*Logo and link to that logo to get viewer back to top of the page*/}
        <Link to="/" className='flex items-center gap-2' onClick={() => {setActive(""); window.scrollTo(0, 0);}}>
          <img src={logo} alt="logo" className='w-40 h-20 object-contain'/>
        </Link>

        {/*List of navigation items taken from \src\constants\index.js*/}
        ...
        {/*List of navigation items taken from \src\constants\index.js MOBILE*/}
